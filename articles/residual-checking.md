...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 6.735 seconds (Warm-up)
#> Chain 1:                4.879 seconds (Sampling)
...
#> SAMPLING FOR MODEL 'tmb_generic' NOW (CHAIN 1).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002128 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 21.28 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 32.523 seconds (Warm-up)
#> Chain 1:                32.182 seconds (Sampling)
#> Chain 1:                64.705 seconds (Total)
#> Chain 1:
